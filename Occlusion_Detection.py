...
json_path = f"{main_path}json_temp"
        ...
        if file_name_1.endswith(suffix):
            ...
            for line in lines:
                ...
                if "frame" in line:
                    ...
                    if "BL1_" in name or "BL2_" in name or "GB1_" in name:

                        if 1 <= frame_num <= 36:
                            y_center -= 0.015

                        elif 37 <= frame_num <= 72:
                            y_center -= 0.01

                        elif 73 <= frame_num <= 108:
                            y_center -= 0.007

                        elif 109 <= frame_num <= 144:
                            y_center -= 0.01

                    elif "ST4_" in name or "ST1_" in name:
